...
<body>
    <header class="header inicio">
        <div class="contenedor contenido-header">
            ...
            <h1>Inmobiliaria & Constructora San Miguel</h1>
        </div>
    </header>
        ...
        <div class="contenedor-anuncios">
            ...
            <div class="anuncio">
                <picture>
                    ...
                    <img loading="lazy" src="build/img/logonativo.svg" alt="anuncio">
                </picture>
            ...
            <div class="anuncio">
                <picture>
                    ...
                    <source srcset="build/img/catt.jpg" type="image/jpej">
        ...
        <section class="blog">
            ...
            <article class="entrada-blog">
                ...
                <div class="texto-entrada">
                    ...
                    <!-- <ul class="iconos-caracteristicas">
                        <li> -->
                    <!-- <img loading="lazy" src="build/img/iconos.jpg" alt="icono wc"> -->
                    <!-- <p>3</p> -->
                    <!-- </li> -->
                </div>
